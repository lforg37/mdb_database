...
GRANT EXECUTE ANY OPERATOR TO user_mmdb;
  ...
  IF UTL_FILE.IS_OPEN(V_FILE) THEN
    LOOP
      BEGIN
        ...
        INSERT INTO IMAGES_TABLE (IMAGE_ID, FILE_PATH) VALUES (V_ID, TO_CHAR(V_PATH));
        V_ID := V_ID+1;
...
GRANT ALL PRIVILEGES ON IMAGES_TABLE TO USER_MMDB;
